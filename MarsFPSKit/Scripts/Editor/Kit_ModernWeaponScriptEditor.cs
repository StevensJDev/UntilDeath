        ...
        public class Kit_ModernWeaponScriptEditor : UnityEditor.Editor
        {
            ...
            public override void OnInspectorGUI()
            {
                ...
                if (reloadFoldout)
                {
                    ...
                    script.animationMultiplier = EditorGUILayout.IntField("Animation Speed multiplier", script.animationMultiplier);
                    script.reloadSpeedTime = EditorGUILayout.FloatField("Reload start/end speed increase", script.reloadSpeedTime);
                    EditorGUILayout.EndVertical();
                }
