...
namespace MarsFPSKit
{
    ...
    public class Kit_Movement_BootsOnGround : Kit_MovementBase
    {
        ...
        public override void updateJumpMax(int jumpNum) {
            jumpMaxCount = jumpNum;
        }

        public override void updateStamina(float uSprintSpeed, float uWalkSpeed, bool hasStamina)
        {
            sprintSpeed = uSprintSpeed;
            walkSpeed = uWalkSpeed;
