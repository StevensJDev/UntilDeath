...
namespace MarsFPSKit
{
    namespace Weapons
    {
        public class ArmsSwimmingControllerRuntimeData
        {
        ...
        public class Kit_ArmsSwimming : Kit_WeaponBase
        {
            ...
            public override void AnimateWeapon(Kit_PlayerBehaviour pb, object runtimeData, int id, float speed)
            {
                ...
                {
                    if (pb.isBot) return;
                    if (runtimeData != null && runtimeData.GetType() == typeof(ArmsSwimmingControllerRuntimeData))
                    {
                        ArmsSwimmingControllerRuntimeData data = runtimeData as ArmsSwimmingControllerRuntimeData;
            ...
            {
                ArmsSwimmingControllerRuntimeData data = new ArmsSwimmingControllerRuntimeData();
