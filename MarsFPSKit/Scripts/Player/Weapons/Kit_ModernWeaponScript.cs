...
namespace MarsFPSKit
{
    namespace Weapons
    {
        ...
        public class Kit_ModernWeaponScript : Kit_WeaponBase
        {
            ...
            private float OriReloadTimeOne, OriReloadTimeTwo;
            /// <summary>
            ...
            private float OriReloadEmptyTimeOne, OriReloadEmptyTimeTwo;
            /// <summary>
            ...
            private float OriReloadProceduralStartTime;
            /// <summary>
            ...
            private float OriReloadProceduralEmptyStartTime;
            /// <summary>
            ...
            public override void SetupValues(int id)
            {
                ...
                OriReloadEmptyTimeTwo = reloadEmptyTimeTwo;
                OriReloadProceduralStartTime = reloadProceduralStartTime;
                OriReloadProceduralEmptyStartTime = reloadProceduralEmptyStartTime;
                OriReloadProceduralEmptyInsertStartTimeOne = reloadProceduralEmptyInsertStartTimeOne;
                OriReloadProceduralEmptyInsertStartTimeTwo = reloadProceduralEmptyInsertStartTimeTwo;
                OriReloadProceduralInsertTimeOne = reloadProceduralInsertTimeOne;
                OriReloadProceduralInsertTimeTwo = reloadProceduralInsertTimeTwo;
                OriReloadProceduralEndTime = reloadProceduralEndTime;
            }
                ...
                if (runtimeData != null && runtimeData.GetType() == typeof(WeaponControllerRuntimeData))
                {
                    ...
                    if (data.weaponRenderer.anim) {
                        ...
                        if (pb.perksManager.playerHasSpeedCola(pb)) {
                                ...
                                if (!updatedValues) {
                                    reloadTimeOne /= reloadSpeedTime;
                                    reloadTimeTwo /= reloadSpeedTime;
                                    reloadEmptyTimeOne /= reloadSpeedTime;
                                    reloadEmptyTimeTwo /= reloadSpeedTime;
                                    reloadProceduralStartTime /= reloadSpeedTime;
                                    reloadProceduralEmptyStartTime /= reloadSpeedTime;
                                    reloadProceduralEmptyInsertStartTimeOne /= reloadSpeedTime;
                                    reloadProceduralEmptyInsertStartTimeTwo /= reloadSpeedTime;
                                    reloadProceduralInsertTimeOne /= reloadSpeedTime;
                                    reloadProceduralInsertTimeTwo /= reloadSpeedTime;
                                    reloadProceduralEndTime /= reloadSpeedTime;
                                    updatedValues = true;
                                }
                            } else {
                            data.weaponRenderer.anim.SetFloat("reloadAnimationSpeed", 1);
                            reloadTimeOne = OriReloadTimeOne;
                            reloadTimeTwo = OriReloadTimeTwo;
                            reloadEmptyTimeOne = OriReloadEmptyTimeOne;
                            reloadEmptyTimeTwo = OriReloadEmptyTimeTwo;
                            reloadProceduralStartTime = OriReloadProceduralStartTime;
                            reloadProceduralEmptyStartTime = OriReloadProceduralEmptyStartTime;
                            reloadProceduralEmptyInsertStartTimeOne = OriReloadProceduralEmptyInsertStartTimeOne;
                            reloadProceduralEmptyInsertStartTimeTwo = OriReloadProceduralEmptyInsertStartTimeTwo;
                            reloadProceduralInsertTimeOne = OriReloadProceduralInsertTimeOne;
                            reloadProceduralInsertTimeTwo = OriReloadProceduralInsertTimeTwo;
                            reloadProceduralEndTime = OriReloadProceduralEndTime;
                            updatedValues = false;
                        }
                    }
            ...
            public void FireOneShot(Kit_PlayerBehaviour pb, WeaponControllerRuntimeData data)
            {
                ...
                //Subtract bullets
                if (!pb.main.gameInformation.debugEnableUnlimitedBullets && !MarsFPSKit.ZombieWaveSurvival.Kit_PvE_ZombieWaveSurvival_DropInfiniteAmmoManager.instance)
                    data.bulletsLeft--;
