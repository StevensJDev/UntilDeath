...
namespace MarsFPSKit
{
    namespace Weapons
    {
        ...
        public abstract class Kit_WeaponBase : ScriptableObject
        {
            ...
            public virtual void QuickUseOnOtherWeaponBegin(Kit_PlayerBehaviour pb, object runtimeData)
            {
            ...
            /// </summary>
            /// <param name="pb"></param>
            public abstract void SetupThirdPerson(Kit_PlayerBehaviour pb, object runtimeData, int[] attachments);
            ...
            /// <param name="id"></param>
            /// <param name="runtimeData"></param>
            public virtual void NetworkMeleeHealRPCReceived(Kit_PlayerBehaviour pb, object runtimeData, int slot)
            {
            ...
            public virtual void OnAmmoPickup(Kit_PlayerBehaviour pb, Kit_AmmoPickup pickup, object runtimeData)
            {
            ...
            /// <param name="pb"></param>
            /// <param name="runtimeData"></param>
            public virtual void RestockAmmo(Kit_PlayerBehaviour pb, object runtimeData)
            {
            ...
            /// <param name="runtimeData"></param>
            /// <returns></returns>
            public virtual bool IsWeaponFull(Kit_PlayerBehaviour pb, object runtimeData)
            {
            ...
            /// <param name="pb"></param>
            /// /// <param name="runtimeData"></param>
            public abstract void BeginSpectating(Kit_PlayerBehaviour pb, object runtimeData, int[] attachments);
            ...
            /// <param name="pb"></param>
            /// /// <param name="runtimeData"></param>
            public abstract void EndSpectating(Kit_PlayerBehaviour pb, object runtimeData);
            #endregion
        }
    }
}