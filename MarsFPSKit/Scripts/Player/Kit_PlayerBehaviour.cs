...
namespace MarsFPSKit
{
    ...
    public class Kit_PlayerBehaviour : MonoBehaviourPunCallbacks, IPunObservable
    {
        ...
        #region Perks
        [Header("Perks")]
        public PerksManagerBase perksManager;
        public object customPerkManagerData; //Used to store custom perk manager data
        #endregion
        ...
        public void updateJumpMax(int jumpNum) {
            movement.updateJumpMax(jumpNum);
        }

        public void updateStamina(float uSprintSpeed, float uWalkSpeed, bool hasStamina){
            movement.updateStamina(uSprintSpeed, uWalkSpeed, hasStamina);
        }
        ...
        void Start()
        {
            movement.updateJumpMax(1);
            movement.updateStamina(6f, 4f, true);
            ...
            //Setup perks
            perksManager.SetupManager(this);
